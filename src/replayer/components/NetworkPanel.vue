...
.net-body.has-detail .net-table-wrap { width: 55%; border-right: 1px solid #252530; }
.net-table-wrap { flex: 1; display: flex; flex-direction: column; overflow: hidden; min-width: 0; }

/* 表头 */
.net-thead {
    display: flex; align-items: center; padding: 5px 10px;
    background: #14141c; border-bottom: 1px solid #252530;
    font-size: 10px; color: #585b70; font-weight: 600; flex-shrink: 0; gap: 8px;
}
...
.col-type { width: 36px; text-align: center; color: #585b70; font-size: 10px; }
.col-time { width: 48px; text-align: right; color: #9399b2; font-size: 10px; }

/* 详情 */
.net-detail { width: 45%; display: flex; flex-direction: column; overflow: hidden; background: #101016; }
.detail-tabs {
    display: flex; align-items: center; gap: 1px; padding: 4px 6px;
    background: #14141c; border-bottom: 1px solid #252530; flex-shrink: 0;
}
.detail-tabs button {
    padding: 3px 10px; border: none; border-radius: 4px;
    background: transparent; color: #585b70; font-size: 11px; cursor: pointer; transition: all 0.15s;
}
.detail-tabs button:hover { color: #cdd6f4; }
.detail-tabs button.active { background: #252530; color: #cba6f7; }
.fmt-btn { font-family: monospace; font-weight: 700; }
.fmt-btn.on { background: #252530; color: #a6e3a1 !important; }
...
.detail-overview { display: flex; flex-wrap: wrap; gap: 6px; padding: 6px 8px; background: #14141c; border-radius: 4px; color: #cdd6f4; margin-bottom: 8px; font-size: 11px; }
.ov-url { color: #bac2de; word-break: break-all; }
.ov-dur { color: #9399b2; }

.detail-block { margin-bottom: 8px; }
.block-title { font-weight: 700; color: #9399b2; margin-bottom: 4px; font-size: 11px; padding-bottom: 2px; border-bottom: 1px solid rgba(255,255,255,0.06); }
.header-row { display: flex; padding: 1px 0; font-size: 11px; gap: 12px; }
.hdr-key { color: #a6adc8; flex-shrink: 0; min-width: 96px; }
.hdr-val { color: #cdd6f4; word-break: break-all; }
.body-pre { font-size: 11px; color: #bac2de; white-space: pre-wrap; word-break: break-all; max-height: 200px; overflow-y: auto; background: #14141c; padding: 6px 8px; border-radius: 4px; margin: 0; }
</style>
